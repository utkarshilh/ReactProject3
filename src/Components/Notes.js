...
export const Notes = (props) => {
    ...
    const handleClick = (e) => {
        console.log("upading the notes", note)
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button disabled={note.etitle.length < 5 || note.etag.length < 5 || note.edescription.length < 5} onClick={handleClick} type="button" className="btn btn-primary">Update Note </button>
                        </div>
                    </div>
                </div>
            </div>
